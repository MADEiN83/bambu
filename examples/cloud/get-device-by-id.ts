// Fetch a single device by its `dev_id`.
//
// Internally calls `devices()` and filters — cache the result if you need it
// repeatedly.
//
// Usage:
//   BAMBU_EMAIL='you@example.com' BAMBU_PASSWORD='xxx' \
//   BAMBU_DEV_ID='00M09B461100094' bun examples/cloud/get-device-by-id.ts
...
const device = await client.getDeviceById(devId);
